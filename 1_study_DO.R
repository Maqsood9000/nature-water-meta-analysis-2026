...
es2 <- metacont(n.e = soc_n_t,
                ...
                data = df1,
                subgroup = df1$Gas_Type,
                subset = Bubble_Size_type %in% c("Small"),
                studlab = paste(df1$authors),
                comb.fixed = FALSE,
                comb.random = TRUE,
                method.tau = "HE",
...
df_summary2 = summary(es2)
df_summary2
write.csv(df_summary2, "Bubble_size_Small.csv")
...
es2 <- metacont(n.e = soc_n_t,
                ...
                data = df1,
                subgroup = df1$Gas_Type,
                subset = Bubble_Size_type %in% c("Large"),
                studlab = paste(df1$authors),
                comb.fixed = FALSE,
                comb.random = TRUE,
                method.tau = "HE",
...
df_summary2 = summary(es2)
df_summary2
write.csv(df_summary2, "Bubble_size_Large.csv")
...
es2 <- metacont(n.e = soc_n_t,
                ...
                data = df1,
                subgroup = df1$Gas_Type,
                subset = Generation_Method %in% c("Adsorption"),
                studlab = paste(df1$authors),
                comb.fixed = FALSE,
                comb.random = TRUE,
                method.tau = "HE",
...
es2
# save txt file
sink("Generation_Method_Adsorption.txt")
print(es2)
sink()
...
df_summary2 = summary(es2)
df_summary2
write.csv(df_summary2, "Generation_Method_Adsorption.csv")
...
es2 <- metacont(n.e = soc_n_t,
                ...
                data = df1,
                subgroup = df1$Gas_Type,
                subset = Generation_Method %in% c("Electrochemical"),
                studlab = paste(df1$authors),
                comb.fixed = FALSE,
                comb.random = TRUE,
                method.tau = "HE",
...
es2
# save txt file
sink("Generation_Method_Electrochemical.txt")
print(es2)
sink()
...
df_summary2 = summary(es2)
df_summary2
write.csv(df_summary2, "Generation_Method_Electrochemical.csv")
...
es2 <- metacont(n.e = soc_n_t,
                ...
                data = df1,
                subgroup = df1$Gas_Type,
                subset = Generation_Method %in% c("Hybrid"),
                studlab = paste(df1$authors),
                comb.fixed = FALSE,
                comb.random = TRUE,
                method.tau = "HE",
...
es2
# save txt file
sink("Generation_Method_Hybrid.txt")
print(es2)
sink()
...
df_summary2 = summary(es2)
df_summary2
write.csv(df_summary2, "Generation_Method_Hybrid.csv")
...
es2 <- metacont(n.e = soc_n_t,
                ...
                data = df1,
                subgroup = df1$Gas_Type,
                subset = Generation_Method %in% c("Membrane_diffusion"),
                studlab = paste(df1$authors),
                comb.fixed = FALSE,
                comb.random = TRUE,
                method.tau = "HE",
...
es2
# save txt file
sink("Generation_Method_Membrane_diffusion.txt")
print(es2)
sink()
...
df_summary2 = summary(es2)
df_summary2
write.csv(df_summary2, "Generation_Method_Membrane_diffusion.csv")
